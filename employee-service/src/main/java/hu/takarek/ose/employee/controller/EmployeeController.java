package hu.takarek.ose.employee.controller;
...
import hu.takarek.ose.employee.repository.EmployeeRepository;
...
public class EmployeeController {
	...
	public Employee add(@RequestBody Employee employee) {
		registry.counter("employee.add","level", "normal").increment();
	...
	public Employee findById(@PathVariable("id") String id) {
		registry.counter("employee.find", "level","normal").increment();
